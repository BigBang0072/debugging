'''
This code is take from the following repo:
https://github.com/shauli-ravfogel/nullspace_projection

which describes a method to remove the information about a topic
through repeated null-space-projection of the topic clasisifer
from the learnt encoder.
'''
