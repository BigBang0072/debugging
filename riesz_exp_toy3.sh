...
#                         for tmle_lambda in 0
#                         do
#                             for l2_lambda in  0.0 #0.0 0.1 1.0 10.0 100.0 200.0 1000.0 #we dont need this when h=0
#                             do
#                                 for noise in 0.0
#                                 do 
#                                     for dcf in 0.0
