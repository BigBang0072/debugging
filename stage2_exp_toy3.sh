...
for run_num in 10 #1 2
do
    for hwidth in 0.05 0.1 0.2 0.5 1.0
    do 
        for te_lambda in  0 #0 10 100
        do
            for pos_size in 1
            do
                for noise in 0.0
