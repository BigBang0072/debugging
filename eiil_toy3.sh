...
for run_num in 0 #14 15 #10 11 12 #1 2
do
    for s1epoch in 10 #2 6
    do  
        for eiil_disc_epoch in 10 #5 10
        do
            for irm_lambda in 10 #10
            do 
                for dcf in 1.0
                do 
                    for noise in 0.0
