...
dtype="mnist"
num_topics=1
topic_name="rotation" #"color" #color is causal and rotation in spurious
...
for run_num in  9 10 11 #10 11 #9 10 11 #9 10 11
do 
    for hlayer in 1 #1 2
    do 
        for debug_tidx in 0
            ...
            do
                ...
                do 
                    ...
                    do
                        for tmle_lambda in 0
                        do
                            for l2_lambda in  0.1 #0.0 1.0 10.0 100.0 200.0 1000.0 #we dont need this when h=0
                            do
                                for noise in 0.3
                                do 
                                    for dcf in 0.0
